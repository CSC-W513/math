...
function displayQuestions(questions) {
    ...
    newTab.document.write('body { font-family: Arial, sans-serif; margin: 15px; }');
    newTab.document.write('h1 { font-size: 20px; margin-top: 20px; }');
    newTab.document.write('.grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; }');
    newTab.document.write('.question, .answer { font-size: 18px; margin: 15px 0; }');
    ...
    questions.forEach(q => {
        newTab.document.write(`<div class="question">${q.question}</div>`);
    });
